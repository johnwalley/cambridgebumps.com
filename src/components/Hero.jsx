  ...
  return (
    <Container className="pt-20 pb-16 text-center lg:pt-32">
      <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl">
        Frankly the most{" "}
        <span className="relative whitespace-nowrap text-cambridge">
          <svg
            aria-hidden="true"
            viewBox="0 0 418 42"
            className="absolute top-2/3 left-0 h-[0.58em] w-full fill-cambridge/30"
          ...
          <span className="relative">bonkers</span>
        </span>{" "}
        sporting event.
      </h1>
